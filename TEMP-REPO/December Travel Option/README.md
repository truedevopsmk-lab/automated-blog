...
---
<!-- inject-nav -->
Here you go, Jarvis — clean, structured **Markdown**, ready for GitHub or any README.
...
## 🛫 Outbound: Bengaluru (BLR) → Budapest (BUD)
...
**Layover in Amsterdam (AMS):** 2h 45m
...
**Layover in Paris (CDG):** 1h 45m

### **Segment 2**

* **Flight:** Air France 194
* **Departure:** 10:15 AM
* **Arrival:** 12:15 AM (+1 day)
* **Duration:** 9h 30m
* **Aircraft:** Boeing 777
* **Class:** Coach (R)
...
Provide these details to a travel agent to match the exact fare and booking classes.
...
| -------------------------------------------- | ---- | ------- |
| India GST (Interim Domestic & International) | K3   | ₹2,226  |
| Netherlands Security Service Charge          | CJ   | ₹1,278  |
| India User Development Fee                   | IN   | ₹1,770  |
| India Aviation Security Fee                  | P2   | ₹1,255  |
| Netherlands Passenger Service Charge         | RN   | ₹1,518  |
| KLM YQ surcharge                             | YQ   | ₹4,669  |
| KLM YR surcharge                             | YR   | ₹29,240 |
| Czech Republic Embarkation Tax               | CZ   | ₹2,951  |
| France Safety & Security Tax                 | FR   | ₹339    |
| France Passenger Service Charge Intl         | QX   | ₹2,367  |

### **Subtotal per passenger:** ₹58,208

### **Passengers:** ×2

### **Total airfare & taxes:** **₹116,416**
...
```
BLR KL X/AMS KL BUD 52.77RGS0TBLA /-PRG AF X/PAR S1.16 AF BLR 65.39RGS0TBLA 
NUC 119.32 END ROE 88.77033 
XT 1770IN 2226K3 1255P2 1278CJ 1518RN 2951CZ 339FR 2367QX 4669YQ 29240YR
```
...
* **Changes:** Penalty fee applies
* **Refunds:** *Non-refundable*
* **Cancellations:** Penalty fee applies
